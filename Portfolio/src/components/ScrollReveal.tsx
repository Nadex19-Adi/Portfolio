...
const Word = ({ children, progress, range, baseOpacity, enableBlur, blurStrength }: WordProps) => {
...
const ScrollReveal = ({
  ...
  containerClassName = '',
  textClassName = '',
  rotationEnd = 'bottom bottom', // Left for API compatibility
  wordAnimationEnd = 'bottom bottom' // Left for API compatibility
}: any) => {
